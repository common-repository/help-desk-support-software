...
jQuery(document).ready(function($) {
    ...
    jQuery(".dashboard-subscribe").on("click", function(e) {
        ...
        if (jQuery.trim(jQuery("#email").val()) === '') {
            jQuery("#frm_shd_dashboard_subscribe").after('<span class="ssign-error" style="color:#fff;margin-bottom:10px;">Email is required.</span>');
            error++;
        } else if (!ValidateEmail(jQuery.trim(jQuery("#email").val()))) {
            jQuery("#frm_shd_dashboard_subscribe").after('<span class="ssign-error" style="color:#fff;margin-bottom:10px;">Invalid email.</span>');
            error++;
        }
        ...
        if (error > 0) {
            ...
            var data = {
                ...
                'data': jQuery("#frm_shd_dashboard_subscribe").serialize(),
